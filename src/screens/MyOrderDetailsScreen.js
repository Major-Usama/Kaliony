  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.oredrNumberContainer}>
        ...
        <View>
          <Text style={styles.oredrnmberText}>Order No238562312</Text>
      ...
      <Text
        style={{
          ...styles.typeText,
          color: type === "Processing" ? "#8E8E8E" : "#27AE60",
        }}
      >
        {type}
      </Text>
      ...
      <View style={styles.oredrProductContainer}>
        ...
        <View style={{ marginLeft: 18 }}>
          <Text style={styles.productTitle}>
            SMOK Nord 50w Kit{"\n"}
            <Text style={{ ...styles.productTitle, fontFamily: "SFRegular" }}>
              Quantity:1
            </Text>
          </Text>

          <Text style={styles.orderPrice}>21500</Text>
        </View>
      </View>
