import { Platform, SafeAreaView, StatusBar, StyleSheet, Text, View ,
TouchableOpacity,Image,TextInput,FlatList,Button, Dimensions,
} from 'react-native';
...
export default function ProductsPageScreen({navigation}) {
  ...
  return (
    ...
    >
     ...
     <Text
     style={{...styles.sortingText,color:isModalVisible===true?'#fff':'#5D88D8'}}
     >Sorting</Text>
    </TouchableOpacity>
